<x-app-layout>
    ...
    <div id="more" class="section h-auto sm:min-h-screen">
        <div class="container grid sm:flex justify-end w-full h-full items-center relative z-[2]">
            ...
            <div class="w-full flex flex-col justify-center sm:items-end">
    ...
    <div class="container flex justify-center items-center h-auto sm:min-h-screen py-8 px-10 sm:px-20 mt-16 sm:mt-0">
    ...
    <div id="bepartner" class="container h-auto sm:min-h-screen justify-center items-center flex flex-col">
        <div>
            <h3 class="text-rifleGreen font-saol font-bold text-5xl">Be a Partner</h3>
        </div>
        <div class="grid h-auto sm:grid-cols-2 mt-16">
