<div>
    <section class="bg-rifleGreen text-platinum shadow mb-12">
        <div class="px-8 py-6">
        ...
        <footer class="px-8 py-6 w-full flex bg-slate-900/20 border-t border-deer">
            <button class="btn ml-auto bg-goldenrod hover:bg-deer text-white border-none rounded-none" id="card-button"
    ...
    @if (count($paymentMethods))
        <section class="bg-rifleGreen text-platinum shadow">
            <header class="px-8 py-6 bg-slate-900/20 border-b border-deer">
