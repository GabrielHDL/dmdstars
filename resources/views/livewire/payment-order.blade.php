<div>
    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-6 container py-8">
        ...
        <div class="order-2 lg:order-1 xl:col-span-3">
            <div class="bg-rifleGreen shadow-lg px-6 py-4 mb-6">
            ...
            <div class="bg-rifleGreen shadow-lg p-6 mb-6">
                <div class="grid grid-cols-2 gap-6 text-platinum">
                    ...
                    <div>
                        <p class="text-lg font-saol font-bold">Contact Information</p>

                        <p class="text-sm">Person who will receive the product(s): {{ $order->contact }}</p>
                        <p class="text-sm">Contact phone number: {{ $order->phone }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-rifleGreen shadow-lg p-6 mb-6">
                <div class="flex justify-between items-center">
                    ...
                    <div class="text-platinum">
                        <p class="text-sm">
                            <span class="font-proximaBold">Subtotal:</span>
                            ${{ $order->total - $order->shipping_cost }} USD
                        </p>
                        <p class="text-sm">
                            <span class="font-proximaBold">Shipping:</span> ${{ $order->shipping_cost }} USD
                        </p>
