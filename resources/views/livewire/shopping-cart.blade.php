            ...
            <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                ...
                <div class="mt-6 h-full border bg-rifleGreen p-6 shadow-md md:mt-0 md:w-1/3 text-goldenrod">
                    ...
                    <a href="{{ route('orders.create') }}"
                        class="btn rounded-none border-none mt-6 w-full bg-goldenrod uppercase font-semibold py-1.5 text-white hover:bg-deer">Create
                        Order</a>
                </div>
            </div>
        @else
            <div class="container flex justify-center items-center min-h-[50vh] flex-col">
                ...
                <a class="mt-8 btn border-none rounded-none bg-goldenrod uppercase font-semibold py-3 px-8 text-white hover:bg-deer"
